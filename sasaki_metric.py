    ...
    def geodesic_discrete(self, initial_point, end_point, n_steps=None, **kwargs):
        ...
        def grad(pu):
            ...
            for j in range(Ns - 1):
                ...
                v, w = metric.log(p3, p2), par_trans(u3, p3, end_point=p2) - u2
                gp = metric.log(p3, p2) + metric.log(p1, p2) + metric.curvature(u2, w, v, p2)
                gu = par_trans(u3, p3, end_point=p2) - 2 * u2 + par_trans(u1, p1, end_point=p2)
                g.append([gp, gu])
        ...
        for i in range(1, Ns):
            ...
            u_ini = (1 - s[i]) * par_trans(u0, p0, end_point=p_ini) + s[i] * par_trans(uL, pL, end_point=p_ini)
